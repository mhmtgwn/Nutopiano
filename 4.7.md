...
- [ ] **SH-18** `ÖNEMLİ` **N+1 Sorgu Düzeltmesi** *(4 saat)*  
...
- [ ] **SH-21** `ÖNEMLİ` **Komisyon Race Condition** *(3 saat)*  
...
- [ ] **SH-22** `ÖNEMLİ` **SEO Meta Tag'leri** *(4 saat)*  
